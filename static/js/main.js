...
$(document).ready(function () {
  ...
  $('.mapsContainer').click(function (event) {
    if ($(event.target).is('.yandex__btn') && $('.yandexMaps').css('display') == 'none') {
      $(this).find('div').hide(500);
      $(this).find('.yandexMaps').show(500);
    } else if ($(event.target).is('.google__btn') && $('.googleMaps').css('display') == 'none') {
      $(this).find('div').hide(500);
      $(this).find('.googleMaps').show(500);
    } else if ($(event.target).is('.doubleGis__btn') && $('.doubleGisMaps').css('display') == 'none') {
      $(this).find('div').hide(500);
      $(this).find('.doubleGisMaps').show(500);
    }
  });
